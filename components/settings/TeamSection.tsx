...
export default function TeamSection({
  ...
  return (
    <UpgradeGate feature="team-members">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-3">
              <span className="text-xs font-medium text-gray-400 tabular-nums whitespace-nowrap">
                {t('team.memberCount').replace('{count}', String(members.length))}
              </span>
              {isManager && (
                <button
                  type="button"
                  ...
                  className="flex items-center gap-1.5 rounded-lg bg-slate-900 px-3.5 py-1.5 text-sm font-medium text-white transition-all duration-150 hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed"
                >
